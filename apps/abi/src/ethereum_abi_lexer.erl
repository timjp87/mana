...
yystate(39, [C|Ics], Line, Tlen, _, _) when C >= 97, C =< 110 ->
    yystate(11, Ics, Line, Tlen+1, 2, Tlen);
yystate(39, [C|Ics], Line, Tlen, _, _) when C >= 112, C =< 120 ->
    yystate(11, Ics, Line, Tlen+1, 2, Tlen);
...
yystate(26, [10|Ics], Line, Tlen, _, _) ->
    yystate(26, Ics, Line+1, Tlen+1, 9, Tlen);
...
yystate(10, [98|Ics], Line, Tlen, Action, Alen) ->
...
yystate(10, [C|Ics], Line, Tlen, Action, Alen) when C >= 65, C =< 90 ->
    yystate(11, Ics, Line, Tlen+1, Action, Alen);
yystate(10, [C|Ics], Line, Tlen, Action, Alen) when C >= 99, C =< 101 ->
    yystate(11, Ics, Line, Tlen+1, Action, Alen);
yystate(10, [C|Ics], Line, Tlen, Action, Alen) when C >= 106, C =< 114 ->
    yystate(11, Ics, Line, Tlen+1, Action, Alen);
yystate(10, [C|Ics], Line, Tlen, Action, Alen) when C >= 118, C =< 122 ->
    yystate(11, Ics, Line, Tlen+1, Action, Alen);
...
yystate(3, [C|Ics], Line, Tlen, _, _) when C >= 97, C =< 104 ->
    yystate(11, Ics, Line, Tlen+1, 2, Tlen);
yystate(3, [C|Ics], Line, Tlen, _, _) when C >= 106, C =< 116 ->
    yystate(11, Ics, Line, Tlen+1, 2, Tlen);
